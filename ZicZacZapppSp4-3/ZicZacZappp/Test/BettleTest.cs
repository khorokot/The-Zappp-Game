...
namespace Test
{
    ...
    public class BettleTest
    {
        ...
        public void CheckForWinTest2()
        {
            ...
            int mode = 1; // TODO: Initialize to an appropriate value
            Bettle target = new Bettle(P1, P2, mode); // TODO: Initialize to an appropriate value
            string[] array = { "x", "x", "x", "0", "0", "0", "0", "0", "0" }; // TODO: Initialize to an appropriate value
        ...
        public void CheckForWinTest4()
        {
            ...
            int mode = 1; // TODO: Initialize to an appropriate value
            Bettle target = new Bettle(P1, P2, mode); // TODO: Initialize to an appropriate value
            string[] array = { "x", "o", "0", "x", "x", "x", "o", "0", "0" }; // TODO: Initialize to an appropriate value
            bool expected = true; // TODO: Initialize to an appropriate value
            bool actual;
            actual = target.CheckForWin(array);
            Assert.AreEqual(expected, actual);
        ...
        [TestMethod()]
        public void CheckForWinTest5()
        {
            string P1 = "AAA"; // TODO: Initialize to an appropriate value
            string P2 = "BBB"; // TODO: Initialize to an appropriate value
            int mode = 1; // TODO: Initialize to an appropriate value
            Bettle target = new Bettle(P1, P2, mode); // TODO: Initialize to an appropriate value
            string[] array = { "o", "o", "o", "x", "0", "x", "o", "0", "o" }; // TODO: Initialize to an appropriate value
            bool expected = true; // TODO: Initialize to an appropriate value
            bool actual;
            actual = target.CheckForWin(array);
            Assert.AreEqual(expected, actual);
